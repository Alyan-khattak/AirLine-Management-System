...
public class UpdateBooking extends JFrame implements ActionListener {
    ...
    JLabel labelname, labelfname, labelfcode, labelprice;
    ...
    public UpdateBooking(){
        ...
        setSize(1000,700);//setSize(width, height) to set the size of the frame
        ...
        JLabel heading = new JLabel("Update Booking");
        heading.setBounds(420,20,500,35);// setBounds(x, y, width, height)
        heading.setFont(new Font("Tahoma",Font.PLAIN,32));//setFont(Font Objct.(family,type,size))
        heading.setForeground(Color.BLUE);// text color
        ...
        lbldestination.setBounds(60,230,150,25);
        ...
        fetchflight.setBounds(380,280,120,30);
        add(fetchflight);
        ...
        //// Flight Class label
         ...
         flightClass.setBounds(220, 280, 150, 25);
        ...
        // Image Icon
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("airline_management_system/icons/update.png"));
        ...
        /*JButton*/ bookflight = new JButton("Update Booking");
        bookflight.setBackground(Color.BLACK);
        bookflight.setForeground(Color.WHITE);
        bookflight.setBounds(290,520,150,25);
        bookflight.addActionListener(this);
        add(bookflight);
        
        // Price Label
        JLabel lblprice = new JLabel("Price");
        lblprice.setBounds(60, 480, 150, 25);
        lblprice.setFont(new Font("Tahoma", Font.PLAIN, 16));
        add(lblprice);

        labelprice = new JLabel();
        labelprice.setBounds(220, 480, 150, 25);
        add(labelprice);
    ...
    public void actionPerformed(ActionEvent ae){
      if(ae.getSource() == fetchuser){  // if fetchuser button is pressed then we will get user data
        ...
        int confirm = JOptionPane.showConfirmDialog(
                null,
                 "Do you want to Reschedule Your booking?",
        ...
        try {
           ...
           String query = "UPDATE reservation SET "
            ...
            int updated = c.s.executeUpdate(query); // executing Query
                if (updated > 0) {
                    JOptionPane.showMessageDialog(null, "Booking Updated Successfully!");
                } else {
                    JOptionPane.showMessageDialog(null, "PNR Not Found. Update Failed.");
                }
